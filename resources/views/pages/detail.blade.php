                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <div class="members my-2">
                            ...
                            <img src="{{ url('frontend/images/member-6.png') }}" alt="" class="member-image mr-1" />
                        </div>
                        <hr />
                        ...
                        <table class="trip-informations">
                            <tr>
                                ...
                                <td width="50%" class="text-right">{{ \Carbon\Carbon::parse($item->departure_date)->format('d F Y') }}</td>
                            </tr>
                            <tr>
